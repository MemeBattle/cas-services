...
export const createCreateTemporaryTokenService = (request: AxiosInstance) => () => {
    return request.post<SuccessCreateTemporaryToken | ErrorCreateTemporaryToken, SuccessCreateTemporaryToken | ErrorCreateTemporaryToken>(`${CAS_ROUTES.temporaryToken}`)
}
